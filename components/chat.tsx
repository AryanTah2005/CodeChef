    ...
    <section className='py-24 text-zinc-700'>
      <div className='container max-w-3xl'>
        ...
        <div className='mx-auto flex max-w-lg items-center justify-between px-1'>
          <h1 className='font-serif text-2xl font-medium'>AI Cook</h1>
            ...
            {messages.map(m => (
              <div key={m.id} className='mr-6 whitespace-pre-wrap md:mr-12'>
                {m.role === 'user' && (
                  <div className='mb-6 flex gap-3'>
                    ...
                    <div className='mt-1.5'>
                      <p className='font-semibold'>{user?.firstName || 'You'}</p>
                ...
                {m.role === 'assistant' && (
                  <div className='mb-6 flex gap-3'>
                    <Avatar>
                    <AvatarImage src='/robo.jpg' /> {`public/robo.jpg`}
                    </Avatar>
                    <div className='mt-1.5 w-full'>
                      <div className='flex justify-between'>
                        <p className='font-semibold'>ChefBot</p>
